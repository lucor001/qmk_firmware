...
//        SMTD_MT(CKC_A, KC_A, KC_LEFT_GUI)
      SMTD_MT(CKC_SE, KC_S, KC_LEFT_ALT)
      ...
      //Non homerow keys       
      SMTD_LT(CKC_Z, KC_Z, U_BUTTON)
      SMTD_LT(CKC_X, KC_X, KC_RIGHT_ALT)
      SMTD_LT(CKC_DOT, KC_DOT, KC_RIGHT_ALT)
      SMTD_LT(CKC_SLSH, KC_SLSH, U_BUTTON)
      //Thumb keys
      SMTD_LT(CKC_ESC, KC_ESC, U_SYM)
      SMTD_LT(CKC_TAB, KC_TAB, U_NAV)
      SMTD_LT(CKC_ENT, KC_ENT, U_NUM)
      SMTD_LT(CKC_SPC, KC_SPC, U_MOUSE)
      SMTD_LT(CKC_BSPC, KC_BSPC, U_MEDIA)
      SMTD_LT(CKC_DEL, KC_DEL, U_FUN)
  }
};
